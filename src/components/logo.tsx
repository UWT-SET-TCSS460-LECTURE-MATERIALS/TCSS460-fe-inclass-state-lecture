...
export default function Logo({
  ...
  const renderFullLogo = () => (
    <>
      ...
      <circle cx="100" cy="100" r="95" fill="white" opacity="0.9" />
      ...
      <circle cx="100" cy="100" r="20" fill={purple} opacity="0.3" />

      {/* State connection nodes - representing distributed state */}
      {/* Top node */}
      <circle cx="100" cy="40" r="12" fill={blue} opacity="0.9" />
      <line
        x1="100"
        y1="80"
        x2="100"
      ...
      {/* Right node */}
      <circle cx="160" cy="100" r="12" fill={blue} opacity="0.9" />
      <line
        x1="120"
        y1="100"
        x2="148"
      ...
      {/* Bottom node */}
      <circle cx="100" cy="160" r="12" fill={blue} opacity="0.9" />
      <line
        x1="100"
        y1="120"
        x2="100"
      ...
      {/* Left node */}
      <circle cx="40" cy="100" r="12" fill={blue} opacity="0.9" />
      <line
        x1="80"
        y1="100"
        x2="52"
      ...
      {/* Top-right */}
      <circle cx="142" cy="58" r="8" fill={purple} opacity="0.7" />
      <line
        x1="115"
        y1="85"
        x2="136"
      ...
      {/* Bottom-right */}
      <circle cx="142" cy="142" r="8" fill={purple} opacity="0.7" />
      <line
        x1="115"
        y1="115"
        x2="136"
      ...
      {/* Bottom-left */}
      <circle cx="58" cy="142" r="8" fill={purple} opacity="0.7" />
      <line
        x1="85"
        y1="115"
        x2="64"
      ...
      {/* Top-left */}
      <circle cx="58" cy="58" r="8" fill={purple} opacity="0.7" />
      <line
        x1="85"
        y1="85"
        x2="64"
  ...
  const renderMonochromeLogo = () => (
    <>
      ...
      <circle cx="100" cy="40" r="12" fill="#666" />
      <circle cx="160" cy="100" r="12" fill="#666" />
      <circle cx="100" cy="160" r="12" fill="#666" />
      <circle cx="40" cy="100" r="12" fill="#666" />
      <line x1="100" y1="80" x2="100" y2="52" stroke="#999" strokeWidth="2" />
      <line
        x1="120"
        y1="100"
        x2="148"
      ...
      <line
        ...
        strokeWidth="2"
      />
      <line x1="80" y1="100" x2="52" y2="100" stroke="#999" strokeWidth="2" />
    </>
  );
